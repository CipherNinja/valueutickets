<template>
  <div class="rooms-container">
    ...
    <h1 class="section-subtitle">Explore our <span class="highlight">Rooms</span></h1>
        ...
        <div v-for="(room, index) in visibleRooms" :key="index" class="room-card">
          ...
          <div class="room-details">
            ...
            <div class="features">
              ...
              <span> <img src="@/assets/Hotel/iconbed.png" alt="Bed" class="bed-icon"> {{ room.bath }}</span>
              <span> <img src="@/assets/Hotel/wifiicon.png" alt="Bed" class="bed-icon"> {{ room.wifi }}</span>
            </div>
      ...
      rooms: [
        {
          ...
          bath: '1 Bath',
          wifi: 'Wifi',
          description: 'A luxurious experience with top-class amenities.  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum non delectus error repellat amet illo blanditiis? Repellendus veniam corporis pariatur!'
        },
        {
          image: hotel2,
          name: 'Luxury Suite',
          ...
          bath: '1 Bath',
          wifi: 'Wifi',
          description: 'Experience premium services with breathtaking views.  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum non delectus error repellat amet illo blanditiis? Repellendus veniam corporis pariatur!'
        },
        {
          image: hotel3,
          ...
          bath: '1 Bath',
          wifi: 'Wifi',
          description: 'Comfort and elegance with a modern touch.  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum non delectus error repellat amet illo blanditiis? Repellendus veniam corporis pariatur!'
        },
        {
          image: hotel1,
          name: 'Super Deluxe Room',
