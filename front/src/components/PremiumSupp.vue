    ...
    <div class="card">
      ...
      <div class="header">
        ...
        <div class="header-left">
          ...
          <h2 class="title">Premium Support</h2>
        </div>

        <!-- Right Side: Icon -->
        <img src="@/assets/support.jpg" alt="Premium Support" class="icon" />
      </div>

      <!-- Description -->
      <div class="description">
        Skip the line and get easy access to expert assistance when you need it.
      </div>
      ...
      <div class="options">
        ...
        >
          <div class="option-content">
            ...
            <ul class="option-list">
              <li>✔ Faster help with booking changes and cancellations</li>
              <li>✔ Only airline fees & fare difference for changes — no extra charges</li>
              <li>✔ Exclusive priority when you call with your booking phone number</li>
            </ul>

            <span class="read-more">
               <span class="read-more-text">Read More...</span>
               <span class="read-more-icon">&or;</span>
            </span>
          </div>
        </label>
        ...
        <!-- Disclaimer -->
        <p class="disclaimer">* Premium Support Is Non-Refundable Once Purchased.</p>
      </div>
    </div>
  </div>
</template>
